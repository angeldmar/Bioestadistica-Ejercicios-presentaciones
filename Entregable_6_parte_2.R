...
pwrt_5 <- pwr.t.test(d=1, sig.level=0.05, n=5)
str(pwrt_5)
pwrt_5$power * 100
...
pwr.anova.test(k = 3, n = 20, f = 1, sig.level = 0.05)
...
pwrt_50 <- pwr.t.test(d=1, sig.level=0.05, n=50)
pwrt_500 <- pwr.t.test(d=1, sig.level=0.05, n=500)
pwrt_1000 <- pwr.t.test(d=1, sig.level=0.05, n=1000)
pwrt_2000 <- pwr.t.test(d=1, sig.level=0.05, n=2000)
pwrt_3000 <- pwr.t.test(d=1, sig.level=0.05, n=3000)
...
pwranova_5 <- pwr.anova.test(k =3, f=1,sig.level=0.05, n=5)
pwranova_50 <- pwr.anova.test(k =3, f=1,sig.level=0.05, n=50)
pwranova_500 <- pwr.anova.test(k =3, f=1, sig.level=0.05, n=500)
pwranova_1000 <- pwr.anova.test(k =3, f=1, sig.level=0.05, n=1000)
pwranova_2000 <- pwr.anova.test(k =3, f=1, sig.level=0.05, n=2000)
pwranova_3000 <- pwr.anova.test(k =3, f=1, sig.level=0.05, n=3000)
